...
import { validateField } from '../../common/utilities/validation/validation';
import {clearLocalStorage } from '../../common/utilities/localStorageService';

class Logincomponent extends React.Component {

    /**
     * Clear browser local storage on component mounting
     */
    componentDidMount() {
        clearLocalStorage();
    }
    ...
    /**
     * set state on input value change
     */
    handleChange = (event) => {
